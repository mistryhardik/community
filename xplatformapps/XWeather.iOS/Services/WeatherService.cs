        ...
        public static async Task<WeatherResponse> GetWeather(string cityName)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Console.WriteLine("Weather Service", "Result: " + result);
                    return result;
                }

                Console.WriteLine("Weather Service", "Response failed with statuscode: " + response.StatusCode);
                return null;
            }
            catch (Exception ex)
            {
                Console.WriteLine("Weather Service", ex.Message);
                return null;
            }
        }
